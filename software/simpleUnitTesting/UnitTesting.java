 ...
 * 
 * There is also an "Ask" method to simply ask the user whether a test passed. That, for instance, will
 * take care of asking you, the grader, to confirm that a GUI has displayed correctly.
 * 
...
public class UnitTesting{
	...
	public static int testTrue(boolean cond, int points, String msg){
		System.out.print(msg);
		return testTrue(cond,points);
	}
	
	public static int testTrue(boolean cond, int points){
	   totalPoints += points;
		if(cond){
			System.out.println(" PASSED: "+points+"/"+points+" pts.");
			currentPoints += points;
			return points;
		}
		else {
			System.out.println(" FAILED: "+minPoints+"/"+points+" pts.");
    ...
    // Ask the user for evaluation
    public static boolean ask(String question){
        JOptionPane q = new JOptionPane();
        try{
            int r = q.showConfirmDialog(null,question,"About this Test:",JOptionPane.YES_NO_OPTION);
