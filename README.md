 ...
 * LDA is an implementation of LDA with gibbs sampling in java and python.
 * Software: contains a set of very simple software bits i've written to help me out.
